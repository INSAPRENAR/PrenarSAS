...
from api_prenar.serializers.pedidoCompletadoListaGeneralSerializers import PedidoCompletadosListaGeneralSerializer
from rest_framework.pagination import PageNumberPagination

class PedidoCompletadoListaGeneralView(APIView):
    def get(self, request):
        ...
        serializer = PedidoCompletadosListaGeneralSerializer(result_page, many=True)
