...
urlpatterns = [
    ...
    path('despacho/consecutivo/numero/cargue/', NextCargoNumberView.as_view(), name='despacho-consecutivo-numero-cargue'),
    path('control/produccion/version/new/', PedidosProduccionView.as_view(), name='control-produccion-version-new'),
    path('pedido/completados/lista/general/', PedidoCompletadoListaGeneralView.as_view(), name='pedidos-completados-lista-general'),
    path('pedido/pendientes/lista/general/', PedidoPendienteListaGeneralView.as_view(), name='pedidoss-pendientes-lista-general'),
    path('pedidos/completados/cliente/<int:cliente_id>/', PedidoCompletadosView.as_view(), name='listPedidos-completados'),
    path('clientes/completados/', ClientesCompletadosView.as_view(), name='cliente-completados'),
    path('viaje/register', ViajeCreateView.as_view(), name='viaje-register'),
    path('viaje/pedido/<int:pedido_id>', ViajeCreateView.as_view(), name='lista-viaje-pedido'),
    ...
    path("estiva/devuelta/register", EstivaDevueltaView.as_view() ,name="estiva-devuelta-register"),
    path("estiva/devuelta/<int:estiva_id>/update", EstivaDevueltaView.as_view() ,name="estiva-devuelta-register"),
    path("estiva/devuelta/<int:estiva_id>/delete", EstivaDevueltaView.as_view() ,name="estiva-devuelta-register"),
    path('estiva/devuelta/<int:pedido_id>', EstivaDevueltaView.as_view(), name='estiva-devuelta-list'),
    path('reporte/estiva/devuelta/', ReporteEstivasDevueltaView.as_view(), name='estiva-devuelta-list-reporte'),
]